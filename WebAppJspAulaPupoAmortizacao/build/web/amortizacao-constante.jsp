...
<html>
    ...
    <body>
       ...
       <Div id="central">
        <h1>Amortização Constante - Tabela SAC</h1>
        
        <form name="formAmortizConst" action="" method="post">
            <label>Valor do Financiamento(R$):</label>
            <input type="text" name="valor"  size="12" maxlength="12" required pattern="[0-9]+$" title="Preencher somente com números, sem pontos e vírgulas" >
            ...
            <label>Taxa(%):</label>
            <input type="text" name="TaxAmortConst" id="inputidtaxConst" size="2" maxlength="2" placeholder="0,1-20" required pattern="[0-9]+$" title="Preencher somente com números, sem pontos e vírgulas">
