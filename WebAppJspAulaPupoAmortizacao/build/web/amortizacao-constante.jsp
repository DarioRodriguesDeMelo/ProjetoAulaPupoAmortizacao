...
<html>
    ...
    <body>
        ...
        <form name="formAmortizConst" action="" method="post">
            ...
            <input type="number" name="mesesAmortConst" placeholder="2-36" min="2" max="36" placeholder="2-36" size="2" maxlength="2">
            <label>Taxa(%):</label>
            <input type="text" name="TaxAmortConst" id="inputidtaxConst" size="2" maxlength="2" placeholder="0,1-20">
