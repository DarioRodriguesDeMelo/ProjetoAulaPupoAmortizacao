...
<html>
    ...
    <body>
        ...
        <form name="formTabPrice" action="" method="post"> <%-- action vazio significa que vamos receber os dados na própria página--%>
            ...
            <input type="text" name="valor" min="100.00" placeholder="Digite o valor aqui" size="12" maxlength="12" mask="###.##" pattern="\d{3}\.\d{3}\.\d{3}\,\d{2}" />
            ...
            <label>Taxa(%):</label>
            <input type="text" name="TaxAmort" id="inputidtaxprice" size="2" maxlength="2" placeholder="0,1-20">
