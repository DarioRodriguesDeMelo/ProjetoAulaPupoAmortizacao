    ...
    <body>
       ...
       <div id="central">
           ...
           <h1>Tabela Price</h1>
            ...
            <form name="formTabPrice" action="" method="post"> <%-- action vazio significa que vamos receber os dados na pr�pria p�gina--%>
            ...
            <%if (request.getParameter("valor") != null){%>
              ...
              <table border="1">  <%-- criacao da tabela price --%>
                  ...
                  <tr>
                     ...
                     <%--  fazer um for para a cria��o da tabela --%>
                   <% for (int i = 1; i<=n ; i++){ %>                                   
                       <tr>
                        <td> <%=i%> </td> 
                        <td> <%=String.format("%,.2f", Pmt)%> </td> <%-- valor da parcela essa � fixa certo ---%>
                        <td> <%=String.format("%,.2f", Pmt - (Pv*t))%> </td> <%-- Amortiza��o= saldo devedor - juros --%>
